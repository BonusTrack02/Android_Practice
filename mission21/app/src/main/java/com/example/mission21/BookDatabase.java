...
public class BookDatabase {
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase _db) {
            ...
            insertRecord(_db, "Programming Android", "Mednieks, Zigurd", "Oreilly Associates Inc에서 출판");
            insertRecord(_db, "모바일 프로그래밍", "이병옥, 최성민 공저", "에이콘출판사에서 출판");
            insertRecord(_db, "시작하세요! 안드로이드 게임 프로그래밍", "마리오 제흐너 저", "위키북스에서 출판");
            insertRecord(_db, "실전! 안드로이드 시스템 프로그래밍 완전정복", "박선호, 오영환 공저", "DW Wave에서 출판");
       }
    }
